    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Contact TB Construction</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get in touch with our floor restoration experts in London
          </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@tbconstruction.com</p>
                  <p className="text-gray-600">quotes@tbconstruction.com</p>
                </div>
              </div>
            ...
            <form>
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <option value="oiling">Wood Floor Oiling</option>
                  <option value="repairs">Floorboard Repairs</option>
                  <option value="parquet">Parquet Restoration</option>
