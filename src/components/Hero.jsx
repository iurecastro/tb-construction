    ...
    <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
      <div className="md:w-1/2 mb-8 md:mb-0">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a href="tel:+440123456789" className="bg-blue-600 text-white px-6 py-3 rounded-lg text-center hover:bg-blue-700 transition">
            Call Now
          </a>
          ...
          <a href="https://wa.me/440123456789" className="bg-green-500 text-white px-6 py-3 rounded-lg text-center hover:bg-green-600 transition flex items-center justify-center gap-2">
